...
<head>
<title>Society Mentainence System || Galary</title>
...
<div id="wrapper">
 ...
 <div id="main-content">
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $sql="INSERT INTO tblgalary(name) VALUES ('$file')";
    ...
    {
?>
<img style="margin: 5px;" height="250px" width="300px" src="<?php echo "../../gallery/".$row['name'];?>">
<?php
    }
?>
                </div>
